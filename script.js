...
/^\d{1,2}\/\d{1-2}\/\d{4}$/.test(dateString) //10/10/2001

/^\d{4}\/\d{1-2}\/\d{1-2}$/.test(dateString) //2001/1/1

/^\d{4}\-\d{1-2}\-\d{1-2}$/.test(dateString) //2001-1-1

/^\d{1-2}\-\d{1-2}\-\d{4}$/.test(dateString) //1-1-2001
...
// Validates that the input string is a valid date formatted as "mm/dd/yyyy"---WORKING
